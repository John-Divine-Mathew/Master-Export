...
export default function DocumentVault({ onOpenDocPreview }) {
  ...
  return (
    <section className="py-16 sm:py-20 bg-purple-50/20 scroll-mt-20" id="documents">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {documents.map((doc, idx) => (
            <div
              ...
              className="bg-white border border-slate-200/80 rounded-2xl p-5 text-center hover:border-purple-300 hover:shadow-xl hover:shadow-purple-500/5 transition-all duration-200 flex flex-col justify-between items-center cursor-pointer group"
            >
              ...
              <div>
                <h4 className="text-sm font-bold text-slate-900 mb-1 group-hover:text-purple-600 transition-colors">
                  {doc.title}
                </h4>
              ...
              <button
                className="w-full py-1.5 px-3 bg-purple-50/50 group-hover:bg-gradient-to-r group-hover:from-violet-600 group-hover:to-purple-600 group-hover:text-white border border-purple-100 rounded-xl text-xs font-semibold text-purple-900 flex items-center justify-center gap-1.5 transition-all shadow-sm"
              >
